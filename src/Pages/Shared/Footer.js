...
const Footer = () => {
    return (
        <div>
            <footer class="footer text-white p-10 bg-black text-base-content">
  <div>
...
<footer class="footer px-10 py-4 border-t text-white bg-black text-base-content border-base-300">
